...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view){
        ...
        final CharSequence[] items = {getText(R.string.red),
                getText(R.string.green), getText(R.string.yellow), getText(R.string.cyan)
        };
            ...
            public void onClick(DialogInterface dialog, int item) {
                switch (item) {
                    ...
                    case 3:
                        ...
                        relativeLayout.setBackgroundResource(R.color.cyanColor);
                        Toast.makeText(context, R.string.cyan, Toast.LENGTH_LONG).show();
